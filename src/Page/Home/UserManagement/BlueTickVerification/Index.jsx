...
const Index = () => {
  ...
  const handelBluetickApproved = (item) => {
    setblueTickAcceptModel(true);
    setSelectedUser(item);
  };
  const handelBluetickReject = (item) => {
    setblueTickRejectModel(true);
    setSelectedUser(item);
  };
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <MDBBtn
                            ...
                            rounded
                            size="sm"
                            onClick={() => handelBluetickApproved(item)}
                          >
                            <FaCheck />
                          </MDBBtn>
                          <MDBBtn
                            ...
                            rounded
                            size="sm"
                            onClick={() => handelBluetickReject(item)}
                          >
                            <ImCross />
                          </MDBBtn>
                        </td>
